...
$(window).scroll(function(e){ 
  ...
  if ($(this).scrollTop() > 502 && !isPositionFixed){ 
...
<p align = "right">By: Mikhail Balyasin, Georgiana Mihut, Tijana Maksimovic, Hacer Tercanli, Rediet Tesfaye, Daniel Prasetyo</p>
#Foreword
...
<h3>Hacer Tercanli</h3>

Hacer Tercanli is a recent graduate of the Erasmus Mundus Masters course, Research and Innovation in Higher Education (MARIHE). Prior to MARIHE, she worked in public and private higher education institutions in Turkey and completed a Fulbright Master’s program in Applied Linguistics. During her studies she participated in the development projects that involved mapping digital learning environments in Germany and internationalization of higher education in Turkey. Among her professional interests are management of joint and double degree programs, quality assurance, and university-business cooperation.

<h3>Rediet Tesfaye</h3>

Rediet Tesfaye Abebe has taught in Arba Minch University and worked as an applications advisor. His disciplinary background is in Sociology, social work and higher education. He is currently doing doctoral studies in Administrative Sciences at the University of Tampere. He is also an auditor of quality systems at the Finnish Education Evaluation Council. His research interest focuses on the topics of quality assurance and governance in higher education.
