...
1. Interactive graphs which plot means for courses with 10 or more responses on that particular question. See below an explanation on how these means are calculated. Graphs show boxplot distribution of means for 78 courses that satisfied the criterion of having 10 or more responses on that questions. 
